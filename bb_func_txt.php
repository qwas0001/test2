...
Latest File Update: 2018-Oct-11
*/
...
//--------------->
/*
function wrapTextOld($wrap,$text){
...
if($str[$a]==' ' or $str[$a]=="\n") {$symbol=0;}
if($symbol>=$wrap and $foundTag==0 and $foundAmp==0 and isset($str[$symbol+1])) { $chkPhr.=$str[$a].$chunkStr; $symbol=0; }
else $chkPhr.=$str[$a];
...
elseif (strlen($str)>$wrap) $exploded[$i]=chunk_split($exploded[$i],$wrap,$chunkStr);
else{
