...
Copyright (C) 2011,2012,2014-2018 Paul Puzyrev. www.minibb.com
Latest File Update: 2018-Nov-24
*/
...
$compareTL=strlen_unicode(trim(strip_tags($postText)));
...
$postTextSmall=substr_unicode($pTxtSm,0,200);
if(strlen_unicode($postTextSmall)<strlen_unicode($pTxtSm)) $postTextSmall.='...';
