...
user_icq varchar(254) NOT NULL default '',
user_website varchar(100) NOT NULL default '',
user_occ varchar(254) NOT NULL default '',
user_from varchar(254) NOT NULL default '',
user_interest varchar(300) NOT NULL default '',
