...
$l_mysql_error='There was a database error. Please report this problem, describing in steps you were trying to do, to the forums Administrator, or <a href="http://www.minibb.com/forums/" class="mnblnk">contact</a> the developers of this software.'.$brtag;
...
$l_newTopics='Recent Topics first';
...
$l_error_addforumicon='Error: the following image does not exist - ';
...
$l_userErrors[1]='Username must contain only latin letters (a-z and A-Z), numbers (0-9), spaces and underscores, being from 3 to 15 characters in length. Username can not consist of the numbers only, it should not start or end with a specific character, should not contain multiple repeated characters. Please, verify it and try again!';
$l_userErrors[2]='Password must contain only latin letters (a-z and A-Z), numbers (0-9) and underscores, being between 5 and 30 characters in length.';
$l_userErrors[3]='Security verifycation failed: entered passwords didn\'t match!';
$l_userErrors[4]='This email address appears to be malformed, or it has been already taken by the other member.';
$l_userErrors[6]='You must provide a full URL to the website, starting with http:// or https:// .'.$brtag.'This field is possible to fill in only if you have posted at least '.$allowHyperlinks.' useful messages on forum.';

$l_errorUserExists='Sorry, the Username you are trying to register, is already taken. Please, choose another one!';

$l_removeUser='Delete Profile';
$l_enterID='User ID';
$l_cantDeleteUser='Unable to delete this user!';
$l_removeUserMessages='Remove all user\'s messages and topics (user\'s topics will be deleted with possible other users messages inside); not ticking this box means the account will be removed, but all messages posted will stay on forum, as being posted from'.$brtag.'<input type="radio" name="guestname" value="current" checked="checked" /> the current Username, or'.$brtag.'<input type="radio" name="guestname" value="guest" /> the Guest account.';
$l_userDeleted='User has been deleted';
...
$l_userUpdated0='Username has been updated to a guest profile on forums';
$l_userNotUpdated0='User info has not been updated';

$l_stillNoForums='It\'s a beautiful time, but so far, no forums have been installed here. Please, come to check for them later.';

$l_send='Send';
$l_pwdWillBeSent='Please, enter the email address, which has been provided for Registration the forums Profile.'.$brtag.'Follow the message in your Inbox. You will get an instruction on resetting your Password.';
...
$l_onlyIfChangePwd='Fill in only in a case of password change; otherwise leave empty';
...
$l_prefsPassUpdated=$brtag.'Because of the Password change, you will need to re-login on the main forums page.';
...
$l_accessDenied='Wham!.. You are trying to make a step which is wrong. If you are sure this is a mistake, contact the Forums Administrator.';

$l_forumProtected='Our forums are hidden from public. Please, enter the password';
...
/* v2.0 RC4 */
$l_searchFailed='No records are found by the search type specified.';
$l_from='from';

/* v2.0 RC5 */
$l_anonAllowed='Post as a Guest, leaving the Password field blank. You could also enter a Guest name, if it\'s not taken by a member yet. Sign-in and post at once, or just sign-in, bypassing the message\'s text.';
$l_anonDisallowed='Only registered users are allowed to post here. Please, enter your username/password details upon posting a message, or <a href="'.$main_url.'/'.$indexphp.'action=registernew" target="_blank" class="mnblnk">register first</a>.';
$l_banReason='Ban reason';
$l_im=$l_usrInfo[5];

$l_bb_bold='BB code for the Bold Style';
$l_bb_italic='BB code for the Italic Style';
$l_bb_underlined='BB code for the Underlined Style';
...
/* v3.0.1 */
$l_deleteAll='Delete All';
$l_justLockProfile='Keep this profile <strong>blocked</strong>';
$l_userDeactivated='User has been de-activated.';

/* v.3.1 */
$l_errorEmailExists='Sorry, the Email address you are trying to register, is already taken. Please, specify another one!';

/* v.3.3 */
$l_pageNotFoundLinked='<b>Page #{PAGE_NUMBER} not found</b>, probably deleted or never existed. Try to check the <a href="{FIRST_PAGE_LINK}" class="mnblnk">first</a> or the <a href="{LAST_PAGE_LINK}" class="mnblnk">last page</a>.'.$brtag;
