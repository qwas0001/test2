...
$correctErr="<a href=\"{$urlp}\" class=\"mnblnk\">$l_goTopic</a>";
echo load_header(); echo ParseTpl(makeUp('main_warning')); return;
}
else {
$title=$l_itseemserror;
$errorMSG=$l_itseemserror;
$correctErr="<a href=\"".addGenURLPage("{$main_url}/{$indexphp}action=vthread&amp;topic=$topic&amp;forum=$forum", $page)."\" class=\"mnblnk\">$l_back</a>";
echo load_header(); echo ParseTpl(makeUp('main_warning')); return;
}
